...
export const isGameSettings = (obj: unknown) => {
    return (
        (obj as OnlineGameSettingsUI).players !== undefined &&
        Array.isArray((obj as OnlineGameSettingsUI).players) &&
        ...
        typeof (obj as OnlineGameSettingsUI).capacity === 'number' &&
        typeof (obj as OnlineGameSettingsUI).isPrivate === 'boolean' &&
        typeof (obj as OnlineGameSettingsUI).password === 'string'
    );
};
