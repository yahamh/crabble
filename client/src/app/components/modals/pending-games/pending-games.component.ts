...
export class PendingGamesComponent implements AfterContentChecked, OnInit, AfterViewInit {
    ...
    columnsToDisplay = ['id', 'playerName', 'randomBonus', 'timePerTurn', 'dictionary', 'isPrivate'];
    ...
    constructor(
        ...
        this.columns = [
            ...
            },
            {
                ...
                header: 'Joueurs',
                cell: (form: OnlineGameSettings) => `${form.players.join(', ')}`,
                tooltip: (form: OnlineGameSettings, columnDef: string) => this.getToolTip(form, columnDef),
            },
            {
            ...
            },
            {
                ...
                cell: (form: OnlineGameSettings) => (form.isPrivate ? 'privée' : 'publique'),
                tooltip: (form: OnlineGameSettings, columnDef: string) => this.getToolTip(form, columnDef),
            },
        ];
    }
    ...
    ngOnInit() {
        this.pendingGames$.subscribe((gameSettings) => {
            const filteredGameSettings = gameSettings;
